...
class TestPGPKey:
    ...
    @pytest.mark.parametrize("key", [
        ...
        "tests/testdata/seckeys/TestKeyDecryption-RSA.sec.key",
        "tests/testdata/seckeys/TestKeyDecryption-RSASignOnly.sec.key",
        pytest.mark.xfail("tests/testdata/seckeys/TestKeyDecryption-RSA-IDEA.sec.key"),
        ...
        pytest.mark.xfail("tests/testdata/seckeys/TestKeyDecryption-RSA-Camellia128.sec.key"),
        pytest.mark.xfail("tests/testdata/seckeys/TestKeyDecryption-RSA-Camellia192.sec.key"),
        pytest.mark.xfail("tests/testdata/seckeys/TestKeyDecryption-RSA-Camellia256.sec.key"),
    ], ids=[
        "sec-protected-dsa",
        "sec-protected-dsa-signonly",
        "sec-protected-rsa",
